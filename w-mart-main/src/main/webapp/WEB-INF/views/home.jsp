    ...
    <section class="wm-hero">
        <div class="container">
            <div class="row align-items-center gy-5">
                <div class="col-lg-6">
                    <span class="badge wm-section-badge"><i class="bi bi-stars"></i> AI Powered Local B2B Marketplace</span>
                    <h3 class="wm-hero-title">Wholesale ordering that keeps local commerce moving.</h3>
                ...
                <div class="col-lg-5">
                    <div class="wm-hero-image">
                        <img src="${pageContext.request.contextPath}/images/wholemart-home-hero.png"
                             class="img-fluid"
    ...
    <section id="how-it-works">
        <div class="how-card">
            ...
            <div class="steps-track">
                ...
                <div class="connector">
                    <svg viewBox="0 0 60 22" preserveAspectRatio="none">
                    ...
                    <div class="card shadow-sm border-0 rounded-4">
                        ...
                        <div class="card-body px-lg-4">
                            <div class="row g-4">
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <canvas id="expiryManagementChart"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-4">
                <div class="col-lg-7">
                    <div class="wm-dashboard h-100">
                        ...
                        <div class="wm-dashboard-item">
                            <div class="wm-dashboard-icon"><i class="bi bi-box-seam"></i></div>
                        ...
                        <div class="wm-dashboard-item">
                            <div class="wm-dashboard-icon"><i class="bi bi-person-check"></i></div>
                            <div class="wm-dashboard-content">
                        ...
                        <div class="wm-dashboard-item">
                            <div class="wm-dashboard-icon"><i class="bi bi-credit-card"></i></div>
                            <div class="wm-dashboard-content">
                        ...
                        <div class="wm-dashboard-item">
                            <div class="wm-dashboard-icon"><i class="bi bi-truck"></i></div>
                            <div class="wm-dashboard-content">
                ...
                <div class="col-lg-5">
                    <div class="wm-ai-panel h-100">
                        ...
                        <div class="wm-ai-priority high"><i class="bi bi-fire"></i> High Priority</div>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-4 col-md-6">
                            <div class="wm-card h-100">
                                <div class="wm-feature-icon"><i class="bi bi-box-seam"></i></div>
                                ...
                                <ul class="wm-feature-list">
                                    ...
                                    <li><i class="bi bi-check-circle-fill"></i> Auto reorder suggestions</li>
                                    <li><i class="bi bi-check-circle-fill"></i> Product forecasting</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="wm-card h-100">
                                <div class="wm-feature-icon bg-success-subtle"><i class="bi bi-wallet2"></i></div>
                                <h4>Digital Credit Ledger</h4>
                                <p>Keep retailer dues, distributor collections, and payment history synchronized automatically.</p>
                                <ul class="wm-feature-list">
                                    <li><i class="bi bi-check-circle-fill"></i> Credit tracking</li>
                                    <li><i class="bi bi-check-circle-fill"></i> Payment reminders</li>
                                    <li><i class="bi bi-check-circle-fill"></i> Digital statements</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="wm-card h-100">
                                <div class="wm-feature-icon bg-warning-subtle"><i class="bi bi-truck"></i></div>
                                <h4>Smart Delivery</h4>
                                <p>Assign deliveries, optimize routes and track every shipment in real time.</p>
                                <ul class="wm-feature-list">
                                    <li><i class="bi bi-check-circle-fill"></i> Live tracking</li>
                                    <li><i class="bi bi-check-circle-fill"></i> Driver assignment</li>
                                    <li><i class="bi bi-check-circle-fill"></i> Route optimization</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="wm-card h-100">
                                <div class="wm-feature-icon icon-lavender"><i class="bi bi-cart-check"></i></div>
                                <h4>Order Management</h4>
                                <p>From quote to dispatch &mdash; approvals, revisions and order history stay in one thread instead of scattered calls.</p>
                                <ul class="wm-feature-list">
                                    <li><i class="bi bi-check-circle-fill"></i> Bulk order builder</li>
                                    <li><i class="bi bi-check-circle-fill"></i> Approval workflows</li>
                                    <li><i class="bi bi-check-circle-fill"></i> Full order history</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="wm-card h-100">
                                <div class="wm-feature-icon icon-pink"><i class="bi bi-diagram-3"></i></div>
                                ...
                                <ul class="wm-feature-list">
                                    <li><i class="bi bi-check-circle-fill"></i> Branch-wise inventory</li>
                                    <li><i class="bi bi-check-circle-fill"></i> Role-based staff access</li>
                                    <li><i class="bi bi-check-circle-fill"></i> Consolidated reporting</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="wm-card h-100">
                                <div class="wm-feature-icon icon-mint"><i class="bi bi-graph-up-arrow"></i></div>
                                <h4>Business Intelligence</h4>
                                <p>Understand demand, margins and slow-moving stock with reports built for wholesale, not generic retail.</p>
                                <ul class="wm-feature-list">
                                    <li><i class="bi bi-check-circle-fill"></i> Sales &amp; margin trends</li>
                                    <li><i class="bi bi-check-circle-fill"></i> Slow-mover flags</li>
                                    <li><i class="bi bi-check-circle-fill"></i> Exportable reports</li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4">
                    <div class="wm-testimonial-card h-100 shadow-sm">
                        ...
                        <div class="wm-testimonial-who">
                            <div class="wm-testimonial-avatar bg-success-subtle text-success"><i class="bi bi-shop"></i></div>
                ...
                <div class="col-lg-4">
                    <div class="wm-testimonial-card h-100 shadow-sm">
                        ...
                        <div class="wm-testimonial-who">
                            <div class="wm-testimonial-avatar bg-warning-subtle text-warning"><i class="bi bi-box-seam"></i></div>
                ...
                <div class="col-lg-4">
                    <div class="wm-testimonial-card h-100 shadow-sm">
                        ...
                        <div class="wm-testimonial-who">
                            <div class="wm-testimonial-avatar bg-danger-subtle text-danger"><i class="bi bi-truck"></i></div>
...
<div id="loginModal" class="modal-overlay">
    <div class="modal-content">
        <button class="close-button" onclick="closeLoginPopup()">&times;</button>
