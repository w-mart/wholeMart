    ...
    <%@ page import="java.util.List" %>
        ...
        <body class="wm-page-background">
            <% String wmUserName=session.getAttribute("name")==null ? "Guest" :
                String.valueOf(session.getAttribute("name")); List<String> suggestedQuestions = List.of(
                                            ...
                                            <div id="chatLog" class="wm-ai-response wm-chat-log">
                                                <div class="wm-chat-message">
                                                    ...
                                                    <div class="wm-chat-bubble">
                                                        ...
                                                        <br><br>
                                                        I'm ready to help you with your distributor business. Ask me a
                                                        question or choose from the suggestions.
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <form id="chatForm" class="mt-4">
                                                <div class="input-group">
                                                    <input id="chatInput" type="text" class="form-control"
                                                        placeholder="Ask WholeMart AI anything..." autocomplete="off"
                                                        required>
