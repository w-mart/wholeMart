...
<h1 class="wm-title">Order Management</h1><p class="wm-subtitle">Monitor and manage orders from retailers</p>
...
<table class="wm-table"><thead><tr><th>S.No</th><th>Order ID</th><th>Retailer</th><th>Amount</th><th>Status</th><th>Date</th><th>Actions</th></tr></thead><tbody id="ordersBody"><tr><td colspan="7">Loading orders...</td></tr></tbody></table>
<script>
