...
<head>
    ...
    <title>WholeMart | Retailer Cart</title>
    ...
    <div class="wm-app">
        <main>
            <div class="wm-home-container">
                ...
                <section class="wm-home-hero" aria-label="Retailer cart">
                    <h1 class="wm-title">Cart</h1>
                    <p class="wm-subtitle">Review cart items before placing an order</p>

                    <div class="wm-stats">
                        <div class="wm-stat">
                            <div class="wm-stat-icon">T</div>
                            <div><b id="cartLines">0</b><span>Lines</span></div>
                        </div>
                        <div class="wm-stat">
                            <div class="wm-stat-icon">I</div>
                            <div><b id="cartQuantity">0</b><span>Items</span></div>
                        </div>
                        <div class="wm-stat">
                            <div class="wm-stat-icon">$</div>
                            <div><b id="cartTotal">Rs. 0.00</b><span>Amount</span></div>
                        </div>
                    </div>
                    ...
                    <div class="wm-toolbar">
                        <div class="row g-4">
                            <div class="col-md-6">
                                <input id="cartSearch" class="wm-input" type="search" placeholder="Search">
                            </div>
                            <div class="col-md-3">
                                <select id="paymentMode" class="wm-select">
                            ...
                            <div class="col-auto">
                                <button id="placeOrder" class="btn wm-gradient-btn" type="button">Place Order</button>
                            </div>
                            <div class="col-auto">
                                <button id="clearCart" class="btn wm-btn-secondary" type="button">Clear Cart</button>
                            </div>
                        </div>
                    </div>
                        ...
                        document.addEventListener("DOMContentLoaded", function () {
                            ...
                            function render() {
                                ...
                                var filtered = items.filter(function (item) {
                                    ...
                                    return !query || [product.name, product.sku, product.category, product.distributorUserId]
                                            .join(" ")
                                            .toLowerCase()
                                            .indexOf(query) !== -1;
                                });
                                ...
                                cartBody.innerHTML = filtered.length ? filtered.map(function (item, index) {
                                    ...
                                    var productLabel =
                                        ...
                                        "<span class=\"wm-muted-line\">" + sku + " | Distributor #" + (product.distributorUserId || "-") + "</span>";

                                    var quantity = Number(item.quantity || 1);
                                    var quantityControl =
                                        "<div class=\"wm-qty-control\">" +
                                        "<button type=\"button\" data-cart-action=\"decrease\" data-cart-id=\"" + item.id + "\">-</button>" +
                                        "<input class=\"wm-qty-input\" data-cart-action=\"quantity\" data-cart-id=\"" + item.id + "\" type=\"number\" min=\"1\" step=\"1\" value=\"" + quantity + "\">" +
                                        "<button type=\"button\" data-cart-action=\"increase\" data-cart-id=\"" + item.id + "\">+</button>" +
                                        "</div>";
                                    ...
                                    return
                                        ...
                                        "<td>" + money(amount) + "</td>" +
                                        "<td><button class=\"wm-btn wm-btn-danger\" data-cart-action=\"remove\" data-cart-id=\"" + item.id + "\">Remove</button></td>" +
                                        "</tr>";
                            ...
                            cartBody.addEventListener("click", function (event) {
                                ...
                                var item = items.find(function (cartItem) {
                                    return Number(cartItem.id) === cartItemId;
                                });
                                if (!item) return;
