    ...
    <div class="wm-app">
        <main>
            <div class="wm-home-container">
                ...
                <h1 class="wm-title">Products</h1>
                <p class="wm-subtitle" id="productSubtitle">Browse distributor product catalog</p>
                ...
                <div class="wm-toolbar">
                    <div class="row g-4">
                        <div class="col-md-6">
                            <input id="productSearch" class="wm-input" type="search" placeholder="Search">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-auto">
                            <a class="btn wm-gradient-btn" href="/web/retailer/cart">View Cart</a>
                        </div>
                    </div>
                </div>
                ...
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    function render() {
                        ...
                        var filtered = products.filter(function (product) {
                            return !query || [product.name, product.category, product.distributorUserId]
                                    .join(" ")
                                    .toLowerCase()
                                    .indexOf(query) !== -1;
                        });
                        ...
                        productsBody.innerHTML = filtered.length ? filtered.map(function (product, index) {
                            ...
                            return "<tr>" +
                                ...
                                "<td>" + distributorLabel + "</td>" +
                                "<td>" + money(product.unitPrice) + "</td>" +
                                "<td><button class=\"wm-btn wm-btn-secondary\" data-product-id=\"" + product.id + "\">Add</button></td>" +
                                "</tr>";
