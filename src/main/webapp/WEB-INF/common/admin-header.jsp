    ...
    <nav class="navbar navbar-light py-2">
        <div class="container-fluid px-3 wm-header-row">
            <div class="d-flex align-items-center wm-header-left">
                <button id="wmSidebarToggle" class="wm-sidebar-toggle-btn me-2" type="button" aria-label="Toggle navigation drawer"><i class="bi bi-list fs-4"></i></button>
                <a class="navbar-brand wm-logo-wrap" href="${pageContext.request.contextPath}/web/admin/dashboard">
                    ...
                    <div class="wm-logo-line">
                        <div class="wm-logo-title d-flex align-items-center gap-2">WholeMart <span class="badge bg-danger-subtle text-danger-emphasis border border-danger-subtle rounded-pill d-none d-sm-inline-flex" style="font-size: .6rem; letter-spacing: .05em;">ADMIN</span></div>
            ...
            <div class="d-flex align-items-center wm-header-right gap-2">
                ...
                <div class="dropdown">
                    <button class="btn wm-user-btn dropdown-toggle d-flex align-items-center gap-2" data-bs-toggle="dropdown" aria-expanded="false" aria-label="Admin profile menu">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="flex-grow-1 min-w-0">
                                    ...
                                    <div class="d-flex align-items-center gap-2 mt-1">
                                        <span class="badge bg-danger-subtle text-danger-emphasis border border-danger-subtle rounded-pill font-monospace fs-8">Admin Account</span>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item wm-user-menu-item" href="${pageContext.request.contextPath}/web/admin/dashboard"><i class="bi bi-speedometer2"></i><fmt:message key="nav.dashboard"/></a></li>
                        <li><a class="dropdown-item wm-user-menu-item" href="${pageContext.request.contextPath}/web/admin/ai-chat"><i class="bi bi-robot"></i><fmt:message key="nav.ai_chat"/></a></li>
...
<aside id="wmSidebar" class="wm-sidebar wm-driver-sidebar" aria-label="Admin Navigation Sidebar">
            ...
            <div class="d-flex align-items-center gap-3 min-w-0">
                ...
                <div class="flex-grow-1 min-w-0">
                    ...
                    <div class="text-muted fs-8 d-flex align-items-center gap-1">
                        <span class="wm-pulse-dot" style="background-color: var(--bs-danger);"></span> Admin Control
                    </div>
                </div>
            </div>
    ...
    <div class="wm-driver-sidebar-scroll">
        <div class="wm-driver-sidebar-section">
            <div class="wm-driver-sidebar-kicker">PLATFORM</div>
            <ul class="list-unstyled m-0">
                <li><a class="<%= wmUri.contains("/dashboard") ? "active" : "" %>" href="${pageContext.request.contextPath}/web/admin/dashboard"><i class="bi bi-speedometer2"></i><span><fmt:message key="nav.dashboard"/></span></a></li>
                <li><a class="<%= wmUri.contains("/orders") ? "active" : "" %>" href="${pageContext.request.contextPath}/web/admin/orders"><i class="bi bi-bag"></i><span><fmt:message key="nav.orders"/></span></a></li>
                <li><a class="<%= wmUri.contains("/payments") ? "active" : "" %>" href="${pageContext.request.contextPath}/web/admin/payments"><i class="bi bi-cash-coin"></i><span><fmt:message key="nav.payments"/></span></a></li>
                <li><a class="<%= wmUri.contains("/reports") ? "active" : "" %>" href="${pageContext.request.contextPath}/web/admin/reports"><i class="bi bi-bar-chart"></i><span><fmt:message key="nav.reports"/></span></a></li>
            </ul>
        </div>

        <div class="wm-driver-sidebar-section">
            <div class="wm-driver-sidebar-kicker">MANAGEMENT</div>
            <ul class="list-unstyled m-0">
                <li><a class="<%= wmUri.contains("/users") ? "active" : "" %>" href="${pageContext.request.contextPath}/web/admin/users"><i class="bi bi-people"></i><span><fmt:message key="nav.users"/></span></a></li>
                <li><a class="<%= wmUri.contains("/distributor-approvals") ? "active" : "" %>" href="${pageContext.request.contextPath}/web/admin/distributor-approvals"><i class="bi bi-patch-check"></i><span><fmt:message key="admin.distributor_approvals"/></span></a></li>
                <li><a class="<%= wmUri.contains("/driver-approvals") ? "active" : "" %>" href="${pageContext.request.contextPath}/web/admin/driver-approvals"><i class="bi bi-shield-check"></i><span><fmt:message key="admin.driver_approvals"/></span></a></li>
            </ul>
        </div>

        <div class="wm-driver-sidebar-section">
            <div class="wm-driver-sidebar-kicker">TOOLS</div>
            <ul class="list-unstyled m-0">
                <li><a class="<%= wmUri.contains("/ai-chat") ? "active" : "" %>" href="${pageContext.request.contextPath}/web/admin/ai-chat"><i class="bi bi-robot text-success"></i><span><fmt:message key="nav.ai_chat"/></span><span class="badge bg-success-subtle text-success border border-success-subtle rounded-pill ms-auto px-2 py-0 fs-8">AI</span></a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="wm-driver-sidebar-footer">
        <div class="d-flex align-items-center justify-content-between pt-2 border-top border-light-subtle">
            <small class="text-muted fs-8">WholeMart Admin v2.4</small>
